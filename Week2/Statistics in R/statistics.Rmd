...
```{r}
set.seed(1)
z1 <- rnorm(n = 1000000, mean = 10, sd = 5)
hist(z1, breaks=1000)
...
```{r}
###
wilcox_out <- wilcox.test(x = 1:10, y = 5:14)
print(wilcox_out)
str(wilcox_out)
wilcox_out$p.value
```
...
t_test_row(2,logcounts_matrix,metadata = cell_info)
