...
cor_matrix <- cor(assay(dds_subset), method =c("spearman"))
pheatmap(cor_matrix)
...
```{r}
results_CD8_CD4 <- results(dds_final, alpha=0.05, contrast=c("cell_type", "CD8","CD4"))
results_CD8_CD4
summary(results_obj)
...
# convert shrunkenLFC_dds_results_obj to a dataframe and call it 
